...
enum DemoID {
    ...
    static let gestureScroll = "gesture_scroll"
    ...
    static let panCard = "pan_card"
    static let selfRemovingTapCard = "self_removing_tap_card"
    static let selfRemovingPanCard = "self_removing_pan_card"
