...
final class LiveSessionServiceTests: XCTestCase {
    ...
    func testInitLoadsPersistedSessionAsConnected() throws {
        ...
        // New LiveSessionService should preserve the persisted session status
    ...
    func testParseDirectConnectionTarget() {
        let target = LiveSessionService.parseDirectConnectionTarget("com.wzb.UIView-WZB@47164")
        XCTAssertEqual(target, .init(bundleIdentifier: "com.wzb.UIView-WZB", port: 47164))
    }

    func testParseDirectConnectionTargetRejectsInvalidValues() {
        XCTAssertNil(LiveSessionService.parseDirectConnectionTarget("com.wzb.UIView-WZB"))
        XCTAssertNil(LiveSessionService.parseDirectConnectionTarget("@47164"))
