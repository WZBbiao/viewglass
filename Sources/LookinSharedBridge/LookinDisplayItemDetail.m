...
- (instancetype)initWithCoder:(NSCoder *)coder {
    if (self = [super init]) {
        ...
        NSSet *groupClasses = [NSSet setWithArray:@[[NSArray class], [NSMutableArray class], [LookinAttributesGroup class]]];
        ...
        NSSet *itemClasses = [NSSet setWithArray:@[[NSArray class], [NSMutableArray class], [LookinDisplayItem class]]];
