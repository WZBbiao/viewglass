...
public enum LKAttributeRegistry {
    ...
    public struct AttributeMapping {
        ...
        public init(_ setter: String, _ getter: String, _ attrType: LookinAttrType, layer: Bool = false) {
            self.setter = setter
            self.getter = getter
    ...
    private static let mappings: [String: AttributeMapping] = [
        ...
        // UILabel
        "text":                  AttributeMapping("setText:", "text", .nsString),
        ...
        "textColor":             AttributeMapping("setTextColor:", "textColor", .uiColor),

        // UIButton
        "enabled":               AttributeMapping("setEnabled:", "isEnabled", .BOOL),
        "selected":              AttributeMapping("setSelected:", "isSelected", .BOOL),
        "highlighted":           AttributeMapping("setHighlighted:", "isHighlighted", .BOOL),

        // UITextField
        "placeholder":           AttributeMapping("setPlaceholder:", "placeholder", .nsString),

        // UIScrollView
        "contentOffset":         AttributeMapping("setContentOffset:", "contentOffset", .cgPoint),
        "contentSize":           AttributeMapping("setContentSize:", "contentSize", .cgSize),
        "contentInset":          AttributeMapping("setContentInset:", "contentInset", .uiEdgeInsets),
        "scrollEnabled":         AttributeMapping("setScrollEnabled:", "isScrollEnabled", .BOOL),
        "pagingEnabled":         AttributeMapping("setPagingEnabled:", "isPagingEnabled", .BOOL),
        "bounces":               AttributeMapping("setBounces:", "bounces", .BOOL),
        "zoomScale":             AttributeMapping("setZoomScale:", "zoomScale", .double),
        "minimumZoomScale":      AttributeMapping("setMinimumZoomScale:", "minimumZoomScale", .double),
        "maximumZoomScale":      AttributeMapping("setMaximumZoomScale:", "maximumZoomScale", .double),
        "bouncesZoom":           AttributeMapping("setBouncesZoom:", "bouncesZoom", .BOOL),

        // UIStackView
        "spacing":               AttributeMapping("setSpacing:", "spacing", .double),
        "axis":                  AttributeMapping("setAxis:", "axis", .enumInt),
        "alignment":             AttributeMapping("setAlignment:", "alignment", .enumInt),
        "distribution":          AttributeMapping("setDistribution:", "distribution", .enumInt),
